	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Users']))
		{
                        ...
                        if($exist==NULL)
                        {
                            ...
                            $this->render('error', array('link'=>'Volver a Crear Usuario','action'=>'create', 'message'=>'El usuario '.$exist->username.' ya se encuentra registrado...')); 
                        }
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['Users']))
		{
			$model->attributes=$_POST['Users'];
                        $model->password=md5($_POST['Users']['password_new']);
			if($model->save())
				$this->redirect(array('view','id'=>$model->id));
		}
