...
class BikeDescriptionController extends Controller
{
	/**
...
//			'postOnly + delete', // we only allow deletion via POST request
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['BikeDescription']))
		{
			$model->attributes=array_map('strtoupper',$_POST['BikeDescription']);
			if($model->save())
				$this->redirect(array('view','id'=>$model->id));
		}
	...
	{
		$dataProvider=new CActiveDataProvider('BikeDescription');
	...
	{
		$model=new BikeDescription('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['BikeDescription']))
			$model->attributes=$_GET['BikeDescription'];
	 ...
	 * @return BikeDescription the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=BikeDescription::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param BikeDescription $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='bike-description-form')
		{
